package com.vatolinrp.bank.common.model;
...
public class Request implements Serializable
{
  ...
  public String getContentForView()
  {
    ...
    sb.append( "<tr>" )
      ...
      .append( "</td>" )
      .append( "<td>" )
      .append( " | is approved by referent:" )
      .append( "</td>" )
      .append( "<td>" )
      .append( isApprByRef )
      .append( "</td>" )
      .append( "<td>" )
      .append( " | is approved by employee:" )
      .append( "</td>" )
      .append( "<td>" )
      .append( isApprByEmp )
      .append( "</td>" )
      .append( "<td>" )
      .append( " | is approved by inspector:" )
      .append( "</td>" )
      .append( "<td>" )
      .append( isApprByInsp )
      .append( "</td>" )
  ...
  {
    return "Request{" + "id=" + id + ", content='" + content + '\'' + ", isApprByRef=" + isApprByRef + ", credReport='"
      + credReport + '\'' + ", accState='" + accState + '\'' + ", isApprByEmp=" + isApprByEmp + ", isApprByInsp="
      + isApprByInsp + ", conditions='" + conditions + '\'' + ", isCreated=" + isCreated + '}';
  }

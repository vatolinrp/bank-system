...
import com.mkyong.common.dao.RequestDao;
...
public class CreditRequestController
{
    ...
    public ModelAndView getCreditReport(HttpServletRequest request,
                                 HttpServletResponse response,@PathVariable String requestId) throws Exception
    {
        ModelAndView model = new ModelAndView();
        Request requestBean = requestDao.getById(Long.valueOf(requestId));
    ...
    public ModelAndView getAccountState(HttpServletRequest request,
                                        HttpServletResponse response,@PathVariable String requestId) throws Exception
    {
        ModelAndView model = new ModelAndView();
        Request requestBean = requestDao.getById(Long.valueOf(requestId));
    ...
    public ModelAndView askForCreation(HttpServletRequest request,
                                        HttpServletResponse response,@PathVariable String requestId) throws Exception
    {
        ModelAndView model = new ModelAndView();
        Request requestBean = requestDao.getById(Long.valueOf(requestId));
    ...
    public ModelAndView approveByRef(HttpServletRequest request,
                                HttpServletResponse response) throws Exception
    {
        ModelAndView model = new ModelAndView();
        String requestId = request.getParameter("request-id");
    ...
    public ModelAndView approveByInsp(HttpServletRequest request,
                                     HttpServletResponse response) throws Exception
    {
        ModelAndView model = new ModelAndView();
        String requestId = request.getParameter("request-id");
